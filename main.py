...
# API = 'db53663bae2e3b33d925fcb7279e77a2'
# bot = telebot.TeleBot('7649584865:AAHMm0zIKXiODKCGu-jJ3fzZaJGCu6Fm2Jg')  # <-- Вставь свой токен
# user_data = {}
...
# # Для контроля неповторяющихся фактов
# sent_facts = {}

# # Для статистики пользователей
...
#     bot.send_message(message.chat.id, f"📡 <b>Космический факт СССР:</b>\n\n{fact}", parse_mode="HTML")
#     # статистика
#     user_stats.setdefault(user_id, {"facts": 0, "quizzes": 0, "max_score": 0})
...
#     user_id = str(message.from_user.id)
#     stats = user_stats.get(user_id, {"facts": 0, "quizzes": 0, "max_score": 0})
#     bot.send_message(
#         message.chat.id,
#         f"📊 <b>Твоя статистика:</b>\n"
#         f"Фактов просмотрено: {stats['facts']}\n"
#         f"Викторин сыграно: {stats['quizzes']}\n"
#         f"Лучший результат: {stats['max_score']} баллов",
#         parse_mode="HTML"
#     )
